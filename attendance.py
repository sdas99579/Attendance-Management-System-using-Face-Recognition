...
class Attendance:
    def __init__(self,root):
        ...
        bg_img.place(x=0,y=200,width=1370,height=630)
        #title
        ...
        mainframe.place(x=5,y=50,width=1350,height=485)
        #left label frame
        left_frame=LabelFrame(mainframe,bd=2,bg="white",relief=RIDGE,text="Student Attendance Details",font=("times new roman",12,"bold"))
        ...
        left_inside_frame.place(x=0,y=110,width=655,height=330)
        ...
        btn_frame.place(x=0,y=280,width=647,height=35)
        ...
        delete_btn=Button(btn_frame,text="Clear csv",command=self.clearSheet,width=17,font=("times new roman",12,"bold"),bg="blue",fg="white")
        ...
        #Right label frame
        Right_frame=LabelFrame(mainframe,bd=2,bg="white",relief=RIDGE,text="Attendance Details",font=("times new roman",12,"bold"))
        Right_frame.place(x=680,y=10,width=660,height=465)

        table_frame=Frame(Right_frame,bd=2,bg="white",relief=RIDGE)
        table_frame.place(x=5,y=5,width=650,height=435)
    ...
    def clearSheet(self):
        delete=messagebox.askyesno("Data Delete Page","Do you want to clear the file",parent=self.root)
        if delete>0:
            f = open("sourav.csv", "w")
            f.truncate()
            f.close()
