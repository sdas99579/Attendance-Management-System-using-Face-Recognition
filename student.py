...
class Student:
    def __init__(self,root):
        ...
        mainframe.place(x=5,y=50,width=1350,height=550)
        ...
        f_lbl.place(x=3,y=0,width=650,height=120)

        #current course frame
        current_course_frame=LabelFrame(left_frame,bd=2,bg="white",relief=RIDGE,text="Current Course Information",font=("times new roman",12,"bold"))
        current_course_frame.place(x=2,y=120,width=652,height=110)
        ...
        dep_combo["values"]=("Select Department","Computer Science","Mechanical","Electrical","IT")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select Course","BE","ME","MCA","PHD")
        ...
        class_Student_frame.place(x=2,y=230,width=652,height=270)
        ...
        btn_frame.place(x=0,y=180,width=645,height=35)
        ...
        btn_frame1.place(x=0,y=215,width=645,height=35)
        ...
        #Right label frame
        Right_frame=LabelFrame(mainframe,bd=2,relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        Right_frame.place(x=680,y=10,width=660,height=530)

        img_right = Image.open(r"college_images\student5.jpg")
        ...
        Search_frame.place(x=2,y=120,width=652,height=70)
        ...
        table_frame.place(x=2,y=195,width=652,height=310)
...
#================load predefined frontel face from open cv haar cascade for object detection===========
